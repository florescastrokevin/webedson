            ...
            $pedido = new Pedido($_GET['id']);  ?>            
                ...
                $id_cliente = new Clientes(); ?>
                        ...
                        <form name="f1" method="post" action="pedidos.php?action=update&id=<?php echo $pedido->getId() ?>" >
                            ...
                            <div class="row col-md-12"><h4>Datos del Destinatario</h4></div>
                            <div class="row">
                                <div class="col-sx-12 col-sm-6 col-md-6 form-group"><label>Nombre:</label>
...
http://www.donregalo.pe
	...
	function listPedidos(){
		...
		<table  cellspacing="0" cellpading="0" class=' table lisado table-hover' >	
                    <thead>
			<h4><?php echo "Hay ".$num." pedidos seleccionados";?></h4>
                        <tr class="head">
                            <th class='titulo' scope="col"><input type="checkbox" name="print_pedidos" id="print_pedidos">
                            ...
                            <th class='titulo' scope="col"  >Cliente </th>
                            <th class='titulo' scope="col" align="center">Monto  </th>
                            <th class='titulo' scope="col" align="center" style="width: 80px;">Fecha Compra </th>
                            <th class='titulo' scope="col" align="center">Estado </th>
                            <th class='titulo' scope="col" align="center">Destino </th>                            
                            <th class='titulo' scope="col" align="center">Fecha Envio  </th>
                            <th class='titulo' scope="col" align="center">Forma de Pago  </th> 
                            <th class='titulo' scope="col" align="center">Opciones </th>
                        </tr>
                    </thead>
                <tbody> <?php
		$x = 1;
		...
		while ($row = $Query->verRegistro()){
                    ...
                    <tr class=" <?php echo ($x % 2 == 0) ? 'odl' : ''; ?> <?php echo $marcar_fila; ?>">
                        <th align="left" scope="row" class='celda'><input type="checkbox" name="print_pedido_<?php echo $row['id_pedido'] ?>" class="chk-pedido" value="<?php echo $row['id_pedido'] ?>" id="print_pedido_<?php echo $row['id_pedido'] ?>"> <label for="print_pedido_<?php echo $row['id_pedido'] ?>"><?php echo $row['codigo_pedido']?></label></th>
                        ...
                        <td align="center">			
                            <a href='pedidos.php?id=<?php echo $row['id_pedido']?>&action=edit' title="Ver Pedido"><img src="<?php echo _icons_ ?>zoom.png" border="0" /></a>	&nbsp;&nbsp;
                            <a href='<?php echo _url_web_."aplication/webroot/archivos/guias_entrega/guia-entrega-".$row['id_pedido'];?>.pdf' title="Imprimir Guia" download='guia-entrega-<?php echo $row['id_pedido'];?>.pdf'><img src="<?php echo _icons_ ?>ps.gif" border="0" /></a>
