jQuery(document).ready(function(a) {
    ...
    a("#carrito").on('click',function(){
        if (a("#bag-shop").hasClass("open")) {
            a("#bag-shop").removeClass('open');
        }else{
            a('#bag-shop').addClass('open');
            var c = a("body"),
            d = a(b.target).attr("href");
            a(d).addClass("active"), c.css("overflow", "hidden"), c.addClass("offcanvas-open-bag")
        }
    });
    a(".close-bag-shop").on('click',function(){
        c();
    })
    ...
    function c() {
        ...
        b.removeClass("offcanvas-open-bag"), setTimeout(function() {
            b.css("overflow", "visible"), a(".offcanvas-container").removeClass("active"), a("#bag-shop").removeClass('open')
        }, 10)
    }
    ...
    a(".offcanvas-menu .offcanvas-submenu").each(function() {
        a(this).prepend('<li class="back-btn"><a href="#">ATRÁS</a></li>')
    });
