...
handleUnlimitedTabsRender = function() {
    function a(e, a) {
        var t = $(e).closest(".tab-overflow"),
            ...
            i = parseInt($(t).find(".nav.nav-tabs").css(n)),
            o = $(t).width(),
            s = 0,
            l = 0;
        switch ($(t).find("li").each(function() {
            ...
            case "next":
                (r = s + i - o) <= o ? (l = r - i, setTimeout(function() {
                    $(t).removeClass("overflow-right")
                }, 150)) : l = o - i - 80, 0 !== l && ($("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({
                    marginRight: "-" + l + "px"
                }, 150, function() {
            ...
            case "prev":
                var r;
                (r = -i) <= o ? ($(t).removeClass("overflow-left"), l = 0) : l = r - o + 80, $("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({
                    marginRight: "-" + l + "px"
                }, 150, function() {
        ...
        $(".tab-overflow").each(function() {
            ! function(e, a) {
                ...
                if ($(e).find(t).prevAll().each(function() {
                    ...
                    var r = o - i;
                    l != o && (r += 40), $("body").hasClass("rtl-mode") ? $(e).find(".nav.nav-tabs").animate({
                        marginRight: "-" + r + "px"
                    }, s) : $(e).find(".nav.nav-tabs").animate({
                        marginLeft: "-" + r + "px"
                    }, s)
                }
                o != l && i <= l ? $(e).addClass("overflow-right") : $(e).removeClass("overflow-right"), i <= o && i <= l ? $(e).addClass("overflow-left") : $(e).removeClass("overflow-left")
            }(this, 0)
        })
    }
...
handleUnlimitedTopMenuRender = function() {
    ...
    function a(e, a) {
        ...
        switch ($(t).find("li").each(function() {
            ...
            case "next":
                (r = s + i - o) <= o ? (l = r - i + 128, setTimeout(function() {
                    $(t).find(".menu-control.menu-control-right").removeClass("show")
                }, 150)) : l = o - i - 128, 0 !== l && ($("body").hasClass("rtl-mode") ? $(t).animate({
                    marginRight: "-" + l + "px"
                }, 150, function() {
            ...
            case "prev":
                var r;
                (r = -i) <= o ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), l = 0) : l = r - o + 88, $("body").hasClass("rtl-mode") ? $(t).animate({
                    marginRight: "-" + l + "px"
                }, 150, function() {
    ...
    function e() {
        var e = $(".top-menu .nav"),
            ...
            n = $(".top-menu"),
            i = $("body").hasClass("rtl-mode") ? "margin-right" : "margin-left",
            o = (parseInt($(e).css(i)), $(n).width() - 128),
        ...
        s != l && o <= l ? $(e).find(".menu-control.menu-control-right").addClass("show") : $(e).find(".menu-control.menu-control-right").removeClass("show"), o <= s && o <= l ? $(e).find(".menu-control.menu-control-left").addClass("show") : $(e).find(".menu-control.menu-control-left").removeClass("show")
    }
...
handleToggleNavProfile = function() {
    var o = $(".sidebar").attr("data-disable-slide-animation") ? 0 : 250;
    $('[data-toggle="nav-profile"]').click(function(e) {
        ...
        var a = $(this).closest("li"),
            ...
            n = "expanding",
            i = "closing";
        $(t).is(":visible") ? ($(a).removeClass("active"), $(t).removeClass(i)) : ($(a).addClass("active"), $(t).addClass(n)), $(t).slideToggle(o, function() {
            $(t).is(":visible") ? ($(t).addClass("expand"), $(t).removeClass("closed")) : ($(t).addClass("closed"), $(t).removeClass("expand")), $(t).removeClass(n + " " + i)
        })
    })
},
        ...
        $(a).is(":visible") ? ($(t).addClass("closing"), r = !0) : ($(t).addClass("expanding"), d = !0), $(a).slideToggle({
            ...
            progress: function() {
                var e = $("#float-sub-menu"),
                    ...
                    i = $(e).attr("data-menu-offset-top"),
                    o = t.top - $(window).scrollTop(),
                    s = $(window).height();
                if (r && n < o && (o = n < o ? n : o, $("#float-sub-menu").css({
                        top: o + "px",
                        bottom: "auto"
...
$(document).ready(function() {
    $('.ul-menu-admin .has-sub .sub-menu li.active').parent().parent().addClass("expand");
    $('.ul-menu-admin .has-sub .sub-menu li.active').parent().attr("style","display: block;");
