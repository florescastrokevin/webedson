        ...
        if ($upload) {
            if (is_array($upload['tmp_name'])) {
                ...
                foreach ($upload['tmp_name'] as $index => $value) {
                    if ($file_name) {
                        $name_personalizado = date('sdmy').$file_name;
                    }else{
                        $name_personalizado = date('sdmy').$upload['name'][$index];
                    }
                    ...
                    Productos::insertImageProductos($name_personalizado,$_SESSION['id_producto_edit']);
                }
            } else {
