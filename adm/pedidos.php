...
//$categoriasId = $categoria->getAllIdCategorias();
?>
                ...
                <div id="dw-cuerpo">
                    <h1>Pedidos
                                ...
                                <form name="form" class="form_filtro" id="filtro" onSubmit="return validate_search(this)">
                                	<ul>
                                        ...
                                        <li><label>Estado:</label>
                                            <select name="estado" class="noestile" id="estado" style="width:160px">
                                                ...
                                                <option value="PersonaNoUbicada">Cta. Personal</option>
                                            </select>
                                        
                                        </li>
                                        <li><label>Cliente:</label><input class="text ui-widget-content ui-corner-all" type="text" name="cliente" value=""></li>
										 <li><label>Producto:</label><select name="producto" class="noestile" id="producto" style="width:200px">
                        ...
                        <span class="operations">
                            <a href="<?php echo $_SERVER['PHP_SELF']?>"><em>Listar</em><span></span></a>
                            <a id="btn_filtro"><em>Filtros</em><span></span></a>                          
                            <a href="<?php echo $_SERVER['PHP_SELF'] ?>?action=new"><em>Nuevo Pedido</em><span></span></a>
                        </span>
                    </h1>
                    <?php
